...
import SingleBusinessPage from '@/components/cards/single-business-card';
import BusinessHighlightCard from '@/components/cards/business-highlight-card';
...
export async function generateMetadata({ params }: BusinessPageProps) {
  ...
  const shortDescription = stripHtmlAndTruncate(business.description,
    160);
    ...
    <div className='mx-1 md:m-20'>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
         <div className='order-2 md:order-1 md:col-span-2' >
           <SingleBusinessPage business={business}/>
         </div>
